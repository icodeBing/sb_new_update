...
#include "motor_interface/msg/detail/joint_motor__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_interface::msg::JointMotor;
    is_plain =
      (
...
static bool _JointMotor__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const motor_interface::msg::JointMotor *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _JointMotor__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<motor_interface::msg::JointMotor *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointMotor__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const motor_interface::msg::JointMotor *>(
...
static size_t _JointMotor__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_JointMotor(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointMotor__callbacks = {
  "motor_interface::msg",
  "JointMotor",
  _JointMotor__cdr_serialize,
  _JointMotor__cdr_deserialize,
  _JointMotor__get_serialized_size,
  _JointMotor__max_serialized_size
};

static rosidl_message_type_support_t _JointMotor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointMotor__callbacks,
...
{
  return &motor_interface::msg::typesupport_fastrtps_cpp::_JointMotor__handle;
}
