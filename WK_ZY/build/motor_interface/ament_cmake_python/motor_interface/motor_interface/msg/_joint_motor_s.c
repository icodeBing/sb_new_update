...
bool motor_interface__msg__joint_motor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_interface.msg._joint_motor.JointMotor", full_classname_dest, 43) == 0);
  }
  motor_interface__msg__JointMotor * ros_message = _ros_message;
  {  // header
  ...
  {  // joint_names
    ...
    }
    {
      ...
      Py_ssize_t size = 23;
      rosidl_runtime_c__String * dest = ros_message->joint_names;
...
{
  /* NOTE(esteve): Call constructor of JointMotor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_interface.msg._joint_motor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointMotor");
  ...
  {  // joint_names
    PyObject * field = NULL;
    size_t size = 23;
    rosidl_runtime_c__String * src = ros_message->joint_names;
  ...
  {  // kp
    ...
    memcpy(dst, src, 23 * sizeof(double));
    Py_DECREF(field);
  }
  {  // kd
    PyObject * field = NULL;
