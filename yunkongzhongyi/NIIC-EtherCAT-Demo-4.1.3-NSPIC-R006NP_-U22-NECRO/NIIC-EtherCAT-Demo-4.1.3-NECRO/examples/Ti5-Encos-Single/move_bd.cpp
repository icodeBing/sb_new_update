...
void MoveBD::on_cycle() {
    ...
    // *axis->target_position = *axis->velocity_actual_value+1000;
...
void MoveBD::move_CSP() {
    ...
    *axis->target_position = curPos;
    std::cout<<"target_position : "<<*axis->target_position << std::endl;
    std::cout<<"id: "<<axis->axis_id<<"  actual_position : "<<*axis->position_actual_value << "target_position :"<<*axis->target_position<<std::endl;
