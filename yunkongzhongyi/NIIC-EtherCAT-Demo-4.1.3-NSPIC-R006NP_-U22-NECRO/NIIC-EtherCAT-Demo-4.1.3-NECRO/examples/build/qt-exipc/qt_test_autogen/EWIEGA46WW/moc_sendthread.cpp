...
QT_MOC_LITERAL(1, 11, 6), // "sendto"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5), // "char*"
QT_MOC_LITERAL(4, 25, 13), // "slotServoData"
QT_MOC_LITERAL(5, 39, 15), // "ServoControl_t*"
QT_MOC_LITERAL(6, 55, 8) // "servoReq"

    },
    "SendThread\0sendto\0\0char*\0slotServoData\0"
    "ServoControl_t*\0servoReq"
};
...
void SendThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendto((*reinterpret_cast< char*(*)>(_a[1]))); break;
        case 1: _t->slotServoData((*reinterpret_cast< ServoControl_t*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SendThread::*)(char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendThread::sendto)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SendThread::sendto(char * _t1)
{
